...
import umm3601.emergency.EmergencyController;


public class EmergencyRequestHandler {
    private final EmergencyController emergencyController;
    public EmergencyRequestHandler(EmergencyController emergencyController){
     ...
     */
    public String getEmergencyJSON(Request req, Response res){
        res.type("application/json");
        String id = req.params("id");
        String goal;
        try {
            goal = emergencyController.getEmergency(id);
     ...
     */
    public String getEmergency(Request req, Response res)
    {
        res.type("application/json");
        return emergencyController.getEmergencys(req.queryMap().toMap());
    }
     ...
     */
    public String addNewEmergency(Request req, Response res)
    {
...
//                    System.err.println("Adding new emoji [owner=" + owner + ", mood=" + mood + " date=" + date  + ']');
                    return emergencyController.addNewEmergency(owner, name, body, category, startDate, endDate, frequency, status).toString();
                }
